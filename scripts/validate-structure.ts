...
const REQUIRED_ENTRIES: RequiredEntry[] = [
  ...
  { path: 'packages/ai/missing-inputs.ts', type: 'file' },
  ...
  { path: 'packages/project/app-map.ts', type: 'file' },
  ...
  { path: 'scripts/prepare-test-environment.ts', type: 'file' },
  { path: 'scripts/check-app-map.ts', type: 'file' },
  { path: 'scripts/run-mcp-exploration.ts', type: 'file' },
